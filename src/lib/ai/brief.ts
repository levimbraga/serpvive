...
For each action, estimate the traffic impact using LOSS framing first, then recovery:
- "Fixing this stops the loss of ~2 clicks/day and could recover ~60 clicks/month"
...
- Be transparent: "Based on your 6,200 monthly impressions, moving from position #8 to #5 would add ~155 clicks/month"
- Do NOT include dollar amounts, CPC values, or "ad-equivalent value" — express impact in clicks only
