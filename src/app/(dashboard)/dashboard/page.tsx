...
export default async function DashboardPage() {
  ...
  // Free plan: usage is the shared lifetime row count across GSC diagnoses and
  // standalone URL analyses (the welcome auto-diagnosis is a row like any
  // other, so it counts) — shown as "X of N" from the first visit, before any
  // run has happened.
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-[1fr_300px] gap-6">
        ...
        <div className="space-y-4">
          <UsageMeter used={diagnosesUsed} limit={diagnosesLimit} plan={plan} hasGsc={!!site} hasFreeDiagnosis={!!site?.has_free_diagnosis} autoDiagStatus={site?.auto_diagnosis_status ?? "pending"} />
          {hasEngineRun && (
